...
class App(ctk.CTk):
    ...
    def init_parameters_frame(self):
        ...
        self.algorithm_frame.columnconfigure(3, weight=0)
        ...
        self.mj_algorithm_radio = ctk.CTkRadioButton(self.algorithm_frame, text='MJ Method', variable=self.algorithm_var, value='MJ')
        self.mj_algorithm_radio.grid(row=1, column=3, sticky='ew', padx=10, pady=5)
